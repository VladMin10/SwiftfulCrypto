...
class DeveloperPreview {
    ...
    let stat1 = StatisticModel(title: "Market Cap", value: "12.98m", percentageChange: 25.21)
    let stat2 = StatisticModel(title: "Total Volume", value: "1.98B")
    let stat3 = StatisticModel(title: "Portfolio Value", value: "50.1k", percentageChange: -5.69)
